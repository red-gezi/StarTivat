...
class Anber : Character
{
    ...
    public override SkillData BasicSkillData => new SkillData()
    {
        ...
        DefaultTargets = InBattleSystem.Instance.EnemyList.Take(1).ToList(),
        TargetIsEnemy = true,
        Sender = this,
    };
    public override SkillData SpecialSkillData => new SkillData()
    {
        ...
        DefaultTargets = InBattleSystem.Instance.EnemyList,
        TargetIsEnemy = true,
        Sender = this,
    };
    public override SkillData BrustSkillData => new SkillData()
    {
        ...
        DefaultTargets = InBattleSystem.Instance.EnemyList.Skip(2).Take(1).ToList(),
        TargetIsEnemy = true,
        Sender = this,
    };
