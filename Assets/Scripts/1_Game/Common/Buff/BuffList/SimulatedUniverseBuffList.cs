...
using UnityEngine;
public class SimulatedUniverseBuffList : IBaseBuffList
{
        ...
        new Buff((int)BufferName.基础流程)
            ...
            .RegisterEvent<SkillData>( BuffTriggerType.On, BuffEventType.SendSkillData, async eventData=>
            {
                if (eventData.SkillTags.Contains(SkillTag.AreaOfEffect))
                {
                    ...
                    {
                        _ = BattleGameEventManager.ReceiveSkillData(eventData.Clone().RedirectTarget(chara));
                    }
                }
                else if (eventData.SkillTags.Contains(SkillTag.AreaOfEffect))
                {

                    _ = BattleGameEventManager.ReceiveSkillData(eventData.Clone());
                    _ = BattleGameEventManager.ReceiveSkillData(eventData.Clone().RedirectTarget(eventData.Receiver.Left));
                    _ = BattleGameEventManager.ReceiveSkillData(eventData.Clone().RedirectTarget(eventData.Receiver.Right));
                }
                else
                {
                    _ = BattleGameEventManager.ReceiveSkillData(eventData.Clone());
            ...
            .RegisterEvent<SkillData>( BuffTriggerType.On, BuffEventType.ReceiveSkillData, async skillData=>
            {
               ...
               //计算数值
                ...
                {
                    await BattleGameEventManager.BroadcastCharaEvent( BuffEventType.Healing,skillData);
                }
                else if (skillData.SkillTags.Contains(SkillTag.Shield))
                {
                    await BattleGameEventManager.BroadcastCharaEvent( BuffEventType.Shield,skillData);
                }
                else
                {
                    int point=0;
                    ...
                    switch (skillData.SkillElement)
                    {
                        case ElementType.Anemo://风
                            ...
                            {
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Pyro, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Disperse));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Pyro, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Disperse));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Pyro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Disperse));
                                await BattleGameEventManager.BroadcastCharaEvent( BuffEventType.Hit,skillData);
                            }
                            else if (skillData.Receiver.HasElements(ElementType.Hydro))
                            {
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Hydro, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Disperse));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Hydro, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Disperse));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Hydro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Disperse));
                                await BattleGameEventManager.BroadcastCharaEvent( BuffEventType.Hit,skillData);

                            }
                            else if (skillData.Receiver.HasElements(ElementType.Electro))
                            {
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Disperse));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Disperse));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Disperse));
                                await BattleGameEventManager.BroadcastCharaEvent( BuffEventType.Hit,skillData);

                            }
                            else if (skillData.Receiver.HasElements(ElementType.Cryo) || skillData.Receiver.HasElements(ElementType.Frozen))
                            {
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Cryo, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Disperse));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Cryo, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Disperse));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Cryo, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Disperse));
                                await BattleGameEventManager.BroadcastCharaEvent( BuffEventType.Hit,skillData);
                        ...
                        case ElementType.Pyro:
                            ...
                            if (skillData.Receiver.HasElements(ElementType.Hydro))
                            {
                                ...
                                await BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point *1.5f),false, ElementType.Pyro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Evaporation));
                            ...
                            else if (skillData.Receiver.HasElements(ElementType.Electro))
                            {
                                ...
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Overload));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Overload));
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Overload));
                                await BattleGameEventManager.BroadcastCharaEvent( BuffEventType.Hit,skillData);
                            }
                            //火-冰/冻 融化
                            else if (skillData.Receiver.HasElements(ElementType.Cryo) || skillData.Receiver.HasElements(ElementType.Frozen))
                        ...
                        case ElementType.Herb:
                            ...
                            if (skillData.Receiver.HasElements(ElementType.Pyro) || skillData.Receiver.HasElements(ElementType.Burn))
                            {
                                ...
                                await skillData.Receiver.AddElementsAcync(ElementType.Burn, 2);
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Combustion));
                            }
                            //草-水 绽放
                            else if (skillData.Receiver.HasElements(ElementType.Hydro))
                            {
                                await skillData.Receiver.RemoveElementsAcync(ElementType.Hydro);
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Bloom));
                                //添加一个种子状态
                            }
                            //草-雷 原激化
                            else if (skillData.Receiver.HasElements(ElementType.Electro))
                            {
                                ...
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 1.4f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.OriginalActivation));
                            }
                            //草-激 蔓激化
                            else if (skillData.Receiver.HasElements(ElementType.Stimulus))
                            {
                                await skillData.Receiver.AddElementsAcync(ElementType.Stimulus, skillData.TurnsRemaining);
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 1.4f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.RapidActivation));
                            }
                            else
                            {
                        ...
                        case ElementType.Physical:
                            ...
                            {
                                await skillData.Receiver.RemoveElementsAcync(ElementType.Frozen);
                                _ = BattleGameEventManager.ElementalReaction(new ElementalReactionData( (int)(point * 2.5f),false, ElementType.Physical, skillData.TurnsRemaining,skillData.Receiver, ReactionType.ShatteredIce));
                                await BattleGameEventManager.BroadcastCharaEvent( BuffEventType.Hit,skillData);
                            }
                            else
                            {
