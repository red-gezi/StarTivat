...
using UnityEngine;
public partial class SU_BuffList : BaseBuffList
{
    ...
    public new static void Init()
    {
        Buffs = new()
        {
            new Buff()
                ...
                .RegisterEvent<SkillData>( BuffTriggerType.On, BuffEventType.SendSkillData, async eventData=>
                {
                    if (eventData.SkillTags.Contains(SkillTag.AreaOfEffect))
                    {
                        ...
                        {
                            _ = GameEventSystem.ReceiveSkillData(eventData.Clone().RedirectTarget(chara));
                        }
                    }
                    else if (eventData.SkillTags.Contains(SkillTag.AreaOfEffect))
                    {

                        _ = GameEventSystem.ReceiveSkillData(eventData.Clone());
                        _ = GameEventSystem.ReceiveSkillData(eventData.Clone().RedirectTarget(eventData.Receiver.Left));
                        _ = GameEventSystem.ReceiveSkillData(eventData.Clone().RedirectTarget(eventData.Receiver.Right));
                    }
                    else
                    {
                        _ = GameEventSystem.ReceiveSkillData(eventData.Clone());
                ...
                .RegisterEvent<SkillData>( BuffTriggerType.On, BuffEventType.ReceiveSkillData, async skillData=>
                {
                   ...
                   //计算数值
                    ...
                    {
                        await GameEventSystem.BroadcastCharaEvent( BuffEventType.Healing,skillData);
                    }
                    else if (skillData.SkillTags.Contains(SkillTag.Shield))
                    {
                        await GameEventSystem.BroadcastCharaEvent( BuffEventType.Shield,skillData);
                    }
                    else
                    {
                        int point=0;
                        ...
                        switch (skillData.SkillElement)
                        {
                            case ElementType.Anemo://风
                                ...
                                {
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Pyro, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Disperse));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Pyro, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Disperse));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Pyro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Disperse));
                                    await GameEventSystem.BroadcastCharaEvent( BuffEventType.Hit,skillData);
                                }
                                else if (skillData.Receiver.HasElements(ElementType.Hydro))
                                {
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Hydro, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Disperse));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Hydro, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Disperse));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Hydro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Disperse));
                                    await GameEventSystem.BroadcastCharaEvent( BuffEventType.Hit,skillData);

                                }
                                else if (skillData.Receiver.HasElements(ElementType.Electro))
                                {
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Disperse));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Disperse));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Disperse));
                                    await GameEventSystem.BroadcastCharaEvent( BuffEventType.Hit,skillData);

                                }
                                else if (skillData.Receiver.HasElements(ElementType.Cryo) || skillData.Receiver.HasElements(ElementType.Frozen))
                                {
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Cryo, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Disperse));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Cryo, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Disperse));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Cryo, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Disperse));
                                    await GameEventSystem.BroadcastCharaEvent( BuffEventType.Hit,skillData);
                            ...
                            case ElementType.Pyro:
                                ...
                                if (skillData.Receiver.HasElements(ElementType.Hydro))
                                {
                                    ...
                                    await GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point *1.5f),false, ElementType.Pyro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Evaporation));
                                ...
                                else if (skillData.Receiver.HasElements(ElementType.Electro))
                                {
                                    ...
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver.Left, ReactionType.Overload));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver.Right, ReactionType.Overload));
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Overload));
                                    await GameEventSystem.BroadcastCharaEvent( BuffEventType.Hit,skillData);
                                }
                                //火-冰/冻 融化
                                else if (skillData.Receiver.HasElements(ElementType.Cryo) || skillData.Receiver.HasElements(ElementType.Frozen))
                            ...
                            case ElementType.Herb:
                                ...
                                if (skillData.Receiver.HasElements(ElementType.Pyro) || skillData.Receiver.HasElements(ElementType.Burn))
                                {
                                    ...
                                    await skillData.Receiver.AddElementsAcync(ElementType.Burn, 2);
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Combustion));
                                }
                                //草-水 绽放
                                else if (skillData.Receiver.HasElements(ElementType.Hydro))
                                {
                                    await skillData.Receiver.RemoveElementsAcync(ElementType.Hydro);
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 0.25f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.Bloom));
                                    //添加一个种子状态
                                }
                                //草-雷 原激化
                                else if (skillData.Receiver.HasElements(ElementType.Electro))
                                {
                                    ...
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 1.4f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.OriginalActivation));
                                }
                                //草-激 蔓激化
                                else if (skillData.Receiver.HasElements(ElementType.Stimulus))
                                {
                                    await skillData.Receiver.AddElementsAcync(ElementType.Stimulus, skillData.TurnsRemaining);
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 1.4f),false, ElementType.Electro, skillData.TurnsRemaining,skillData.Receiver, ReactionType.RapidActivation));
                                }
                                else
                                {
                            ...
                            case ElementType.Physical:
                                ...
                                {
                                    await skillData.Receiver.RemoveElementsAcync(ElementType.Frozen);
                                    _ = GameEventSystem.ElementalReaction(new ElementalReactionData( (int)(point * 2.5f),false, ElementType.Physical, skillData.TurnsRemaining,skillData.Receiver, ReactionType.ShatteredIce));
                                    await GameEventSystem.BroadcastCharaEvent( BuffEventType.Hit,skillData);
                                }
                                else
                                {
            ...
            new Buff()
                .RegisterName(SU_BuffName.获得金币翻倍)
            ...
            new Buff()
                ...
                .RegisterEvent<OutBattleEventData>(BuffTriggerType.Before, BuffEventType.GoldGain, async (data) => {
                    if (data.TargetValue > 50) {
                        ...
                        await GameEventSystem.GetItem(targets);
                        data.AddLog("获得的金钱-50并得到欠条");
                    }
                }),
            new Buff()
                .RegisterBless(ElementType.Herb, 3, "妙论派", "元素反应加成提高<color=yellow>15%</color>")
                .RegisterEvent<OutBattleEventData>(BuffTriggerType.On, BuffEventType.ItemGain, async (data) => {
                }),
            new Buff()
                .RegisterBless(ElementType.Geo, 2, "琥珀", "护盾自然破碎时产生产生共振，对对方全体造成<color=yellow>200%</color>盾量伤害")
                .RegisterEvent<OutBattleEventData>(BuffTriggerType.Before, BuffEventType.ItemGain, async (data) => {
                }),
            new Buff()
                .RegisterBless(ElementType.Anemo, 1, "苹果酿", "速度提高<color=yellow>20%</color>")
                .RegisterEvent<OutBattleEventData>(BuffTriggerType.Before, BuffEventType.ItemGain, async (data) => {
                }),
            new Buff()
                .RegisterCurio(CurioType.相遇之缘, 2, "相遇之缘", "能带来奇迹的等价交换之物")
                .RegisterEvent<OutBattleEventData>(BuffTriggerType.Before, BuffEventType.ItemGain, async (data) => {
                }),
            new Buff()
                .RegisterCurio(CurioType.纠缠之缘, 3, "纠缠之缘", "能带来没有任何作用的奇迹的等价交换之物")
                .RegisterEvent<OutBattleEventData>(BuffTriggerType.Before, BuffEventType.ItemGain, async (data) => {
                }),
            new Buff()
                .RegisterCurio(CurioType.原石, 1, "原石", "财富的象征")
