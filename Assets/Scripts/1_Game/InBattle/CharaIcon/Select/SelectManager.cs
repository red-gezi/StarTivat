...
public class SelectManager : MonoBehaviour
{
    ...
    {
        InBattleSystem.Instance.charaList.ForEach(chara => chara.largeLock.SetActive(false));
        InBattleSystem.Instance.charaList.ForEach(chara => chara.smallLock.SetActive(false));
        //启动目标模型的大框
