...
public class SelectManager : MonoBehaviour
{
    ...
    {
        InBattleManager.Instance.charaList.ForEach(chara => chara.largeLock.SetActive(false));
        InBattleManager.Instance.charaList.ForEach(chara => chara.smallLock.SetActive(false));
        //启动目标模型的大框
